...
{
    TEST_CASE("Plane - NearestSurfaceIntersection - ray above plane intersecting orthogonally", "[Plane]")
    {
        ...
        auto result = plane.NearestSurfaceIntersection(ray);
    ...
    TEST_CASE("Plane - NearestSurfaceIntersection - ray below plane intersecting orthogonally", "[Plane]")
    {
